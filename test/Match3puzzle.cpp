...
//
//int RensaCheck(int y, int x);	//ブロックの連鎖チェック
...
//{
//	SetMainWindowText(" Match 3 Puzzle(マッチ３パズル)");	//タイトルを設定
...
//			break;
//		case GAME_CLEAR:
//			DrawGameClear();	//ゲームクリア画面描画処理
//			break;
//		case GAME_OVER:
//			DrawGameOver();		//ゲームオーバー画面描画処理
//			break;
//		}
//
...
//			StopSoundMem(g_TitleBGM);	//タイトルBGMを止める
//		}
...
//	//レベルの初期化
//	g_Level = 0;
//	//ミッションの初期化（レベル１は消去するブロック数が３からスタート）
//	g_Mission = 2;
//	//ステージ初期処理
//	StageInit();
//}
...
//			break;
//	}
//	//タイム変数をデクリメントして、０未満ならゲームオーバーへ移行する
//	if (--g_Time < 0) {
...
//* 引数：x：現在のX座標、ｙ：現在のY座標
//*戻り値：１…３つ以上の連鎖、０…連鎖無し 
//**************************************************/
...
//	if (CountH < 3) {
//		RestoreBlock();	//ブロックの連鎖が３個未満ならブロックを戻す
//	}
//
//	int CountW = 0;
//	int ColorW = 0;
...
//		}
//		else {
//			//連鎖が３つ以上ならブロックを消し、ブロック移動処理へ移動する
//			g_Status = 2;
//		}
//		//次にクリックができるように、ClickFlgを０にする。
//		ClickFlg = 0;
//	}
//}
//
...
//		g_Status = 4;
//	}else {
//		//連鎖が３つ以上ならブロックを消し、ブロック移動処理へ移行する
//		g_Status = 2;
//	}
//}
//
