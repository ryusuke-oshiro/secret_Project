...
//int CheckBlock(void);
//
//int LoadSounds(void);		//音楽読み込み
///*******************************************************
//*プログラムの開始
//********************************************************/
//int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevImstance, LPSTR lpCmbLine, int nCmbShow)
//{
...
//
//	if (LoadSounds() == -1)return -1;//総ンdpypも混み関数を呼び出し
//
//	//ゲームループ
...
//	}
//	DrawFormatString(40, 270, 0xffffff, "%3d", Time / 100);
//}
//
///**********************************************
//*ブロック移動
...
//{
//	//タイトルBGM
//	if ((g_TitleBGM = LoadSoundMem("sounds/y2mate.com - Initial D Speed Lover.mp3")) == -1)return -1;
//	//ゲームクリア
...
//	//ブロック画像読み込み（分割読み込み）
//	if (LoadDivGraph("images/block.png", 5, 5, 1, 24, 24, g_BlockImage) == -1)return -1;
//
//	return 0;
//}